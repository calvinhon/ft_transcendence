...
import { LocalPlayerModalManager } from './LocalPlayerModalManager';
import { LocalPlayerDataManager } from './LocalPlayerDataManager';
import { LocalPlayerAuthManager } from './LocalPlayerAuthManager';
import { LocalPlayerUIManager } from './LocalPlayerUIManager';
  ...
  public setupLoginModal(app: any): void {
    ...
    loginForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        logger.error('LocalPlayerManager', 'Exception during login', err);
  ...
  public setupRegisterModal(app: any): void {
    ...
    registerForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        logger.error('LocalPlayerManager', 'Exception during registration', err);
