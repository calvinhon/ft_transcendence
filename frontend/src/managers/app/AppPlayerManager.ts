...
export class AppPlayerManager {
  ...
  constructor() {
    logger.info('AppPlayerManager', '🏗️ AppPlayerManager initialized');
  }
   ...
   */
  cleanup(): void {
    logger.info('AppPlayerManager', '🧹 Cleaning up player manager...');
    ...
    logger.info('AppPlayerManager', '✅ Player manager cleaned up');
  }
}