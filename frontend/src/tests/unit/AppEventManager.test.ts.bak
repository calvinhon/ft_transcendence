...
import { AppEventManager } from '../../managers/app/AppEventManager';
...
describe('AppEventManager', () => {
  ...
  test('should setup form event listeners', () => {
    ...
    expect(logger.info).toHaveBeenCalledWith('AppEventManager', 'Setting up form and navigation event listeners');

    // Check that event listeners were added to elements
    expect(logger.info).toHaveBeenCalledWith('AppEventManager', 'Adding event listener for create-account-link');
    expect(logger.info).toHaveBeenCalledWith('AppEventManager', 'Adding event listener for forgot-password-link');
    expect(logger.info).toHaveBeenCalledWith('AppEventManager', 'Adding event listener for back-to-login-link');
    expect(logger.info).toHaveBeenCalledWith('AppEventManager', 'Adding event listener for back-to-login-from-forgot-link');
  });
  ...
  test('should handle create account link click', () => {
    ...
    expect(logger.info).toHaveBeenCalledWith('AppEventManager', 'Create account link clicked');
  });
  ...
  test('should handle forgot password link click', () => {
    ...
    expect(logger.info).toHaveBeenCalledWith('AppEventManager', 'Forgot password link clicked');
  });
  ...
  test('should handle back to login link click', () => {
    ...
    expect(logger.info).toHaveBeenCalledWith('AppEventManager', 'Back to login link clicked');
  });
  ...
  test('should handle back to login from forgot link click', () => {
    ...
    expect(mockEvent.preventDefault).toHaveBeenCalled();
    expect(mockRouter.navigate).toHaveBeenCalledWith('login');
    expect(logger.info).toHaveBeenCalledWith('AppEventManager', 'Back to login from forgot link clicked');
  });
  ...
  test('should warn when elements are not found', () => {
    ...
    expect(logger.warn).toHaveBeenCalledWith('AppEventManager', 'create-account-link not found');
    expect(logger.warn).toHaveBeenCalledWith('AppEventManager', 'forgot-password-link not found');
    expect(logger.warn).toHaveBeenCalledWith('AppEventManager', 'back-to-login-link not found');
    expect(logger.warn).toHaveBeenCalledWith('AppEventManager', 'back-to-login-from-forgot-link not found');
  });
  ...
  test('should handle missing app or router', () => {
    ...
    expect(logger.error).toHaveBeenCalledWith('AppEventManager', 'App or router not available');
  });
});