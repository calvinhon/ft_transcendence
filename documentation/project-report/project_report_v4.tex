% ! TEX root = /home/danish/Documents/Coding/ft_transcendence/documentation/project-report/project_report_v4.tex
...
\begin{framed}
  ...
  Date of Submission: January 28, 2026\\[1cm]
\end{framed}
\end{titlepage}
...
3 & Data leak via misconfigured logs & 2 & 4 & \cellcolor{yellow!30}8 & Development Team (Hoach \& Calvin) & Redact PII in logs \\
...
\hline
\textbf{Nginx Gateway} & TLS, routing, WAF filtering, rate limiting & 8443 \\
\hline
\textbf{Vault} & Secret storage (API keys) & 8200 \\
\hline
