...
% Abstract
\begin{abstract}
This document presents the comprehensive project report for \textbf{ft\_transcendence}, a full-stack multiplayer Pong platform built with microservices architecture. The project achieves full compliance with all subject requirements, implementing 10 major modules and 6 minor modules with 120/120 automated tests passing. The system features real-time WebSocket gameplay, blockchain-integrated tournaments, comprehensive security hardening (WAF + Vault), basic authentication, GDPR compliance, and production-ready deployment. This report details the software development lifecycle, requirements analysis, design decisions, implementation specifics, comprehensive testing methodology, and evolution roadmap.
\end{abstract}
...
\begin{tabular}{p{0.8cm} p{3.5cm} c c c p{3.5cm} p{4cm}}
\toprule
...
\subsection{Multiplayer (>2 Players)}
...
GDPR compliance with user data anonymization, local data management, and account deletion.
...
\section{Server-Side Pong Implementation}

\subsection{Server-Side Pong and API}
Server-side Pong implementation with API for game state management and CLI integration.
...
\subsection{Support on All Devices}
...
Cybersecurity & 24 & 24/24 (check) \\
Devops & 12 & 12/12 (check) \\
Server-Side Pong & 12 & 12/12 (check) \\
