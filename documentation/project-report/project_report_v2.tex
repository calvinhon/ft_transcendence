...
\subsubsection{5. Account Handling (10 Points) (check)}
Local username/password authentication, session management. \textbf{Test Result:} 12/12 (check)
