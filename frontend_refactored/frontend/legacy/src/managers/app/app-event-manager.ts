...
export class AppEventManager {
  ...
  constructor() {
    logger.info('app-event-manager', '🏗️ AppEventManager initialized');
  }
  ...
  setupKeyboardShortcuts(router: any, gameManager: any): void {
    logger.info('app-event-manager', 'Setting up keyboard shortcuts');
  ...
  setupZoomControl(): void {
    logger.info('app-event-manager', 'Setting up zoom control');
  ...
  private handleLogout(router: any): void {
    ...
    try {
      ...
      logger.warn('app-event-manager', 'playerService.clearAllPlayers failed', e);
    }
  }
  ...
  setupFormEventListeners(): void {
    logger.info('app-event-manager', 'Setting up form and navigation event listeners');

    // Login screen navigation links
    const createAccountLink = document.getElementById('create-account-link');
    if (createAccountLink) {
      logger.info('app-event-manager', 'Adding event listener for create-account-link');
      createAccountLink.addEventListener('click', (e) => {
        logger.info('app-event-manager', 'Create account link clicked');
        e.preventDefault();
        const app = (window as any).app;
        if (app?.router) {
          app.router.navigateToScreen('register');
        } else {
          logger.error('app-event-manager', 'App or router not available');
        }
      });
    } else {
      logger.warn('app-event-manager', 'create-account-link not found');
    }

    const forgotPasswordLink = document.getElementById('forgot-password-link');
    if (forgotPasswordLink) {
      logger.info('app-event-manager', 'Adding event listener for forgot-password-link');
      forgotPasswordLink.addEventListener('click', (e) => {
        logger.info('app-event-manager', 'Forgot password link clicked');
        e.preventDefault();
        const app = (window as any).app;
        if (app?.router) {
      ...
      logger.warn('app-event-manager', 'forgot-password-link not found');
    }

    // Register screen back link
    const backToLoginLink = document.getElementById('back-to-login-link');
    if (backToLoginLink) {
      logger.info('app-event-manager', 'Adding event listener for back-to-login-link');
      backToLoginLink.addEventListener('click', (e) => {
        logger.info('app-event-manager', 'Back to login link clicked');
        e.preventDefault();
        const app = (window as any).app;
        if (app?.router) {
      ...
      logger.warn('app-event-manager', 'back-to-login-link not found');
    }

    // Forgot password screen back link
    const backToLoginFromForgot = document.getElementById('back-to-login-from-forgot-link');
    if (backToLoginFromForgot) {
      logger.info('app-event-manager', 'Adding event listener for back-to-login-from-forgot-link');
      backToLoginFromForgot.addEventListener('click', (e) => {
        logger.info('app-event-manager', 'Back to login from forgot link clicked');
        e.preventDefault();
        const app = (window as any).app;
        if (app?.router) {
          app.router.navigateToScreen('login');
      ...
      logger.warn('app-event-manager', 'back-to-login-from-forgot-link not found');
    }

    // Main menu logout button
    const logoutBtn = document.getElementById('main-menu-logout-btn');
    if (logoutBtn) {
      logger.info('app-event-manager', 'Adding event listener for main-menu-logout-btn');
      logoutBtn.addEventListener('click', (e) => {
        logger.info('app-event-manager', 'Logout button clicked');
        e.preventDefault();
        if (this.app?.handleUserLogout) {
          this.app.handleUserLogout().catch((err) => {
            logger.error('app-event-manager', 'handleUserLogout failed', err);
          });
        } else {
          logger.error('app-event-manager', 'App handleUserLogout not available');
        }
      });
    } else {
      logger.warn('app-event-manager', 'main-menu-logout-btn not found');
    }
    ...
    const playBtn = document.getElementById('play-btn') as HTMLButtonElement;
    if (playBtn) {
      logger.info('app-event-manager', 'Adding event listener for play-btn');
      playBtn.addEventListener('click', (e) => {
        ...
        if (app?.router) {
          ...
          logger.warn('app-event-manager', 'App or router not available for play-btn');
        }
      });
    }
    ...
    if (profileBtn) {
      logger.info('app-event-manager', 'Adding event listener for profile-btn');
      profileBtn.addEventListener('click', (e) => {
        ...
        if (app?.router) {
          ...
          logger.warn('app-event-manager', 'App or router not available for profile-btn');
        }
      });
    }
    ...
    if (settingsBtn) {
      logger.info('app-event-manager', 'Adding event listener for settings-btn');
      settingsBtn.addEventListener('click', (e) => {
        ...
        if (app?.router) {
          ...
          logger.warn('app-event-manager', 'App or router not available for settings-btn');
        }
      });
    }
    ...
    if (backToMainBtn) {
      logger.info('app-event-manager', 'Adding event listener for back-to-main-btn');
      backToMainBtn.addEventListener('click', (e) => {
        ...
        if (app?.router) {
          ...
          logger.warn('app-event-manager', 'App or router not available for back-to-main-btn');
        }
      });
    }
    ...
    if (backToMainProfileBtn) {
      logger.info('app-event-manager', 'Adding event listener for back-to-main-profile-btn');
      backToMainProfileBtn.addEventListener('click', (e) => {
        ...
        if (app?.router) {
          ...
          logger.warn('app-event-manager', 'App or router not available for back-to-main-profile-btn');
        }
      });
    }
    ...
    if (backToMainProfileBottomBtn) {
      logger.info('app-event-manager', 'Adding event listener for back-to-main-profile-bottom-btn');
      backToMainProfileBottomBtn.addEventListener('click', (e) => {
        ...
        if (app?.router) {
          ...
          logger.warn('app-event-manager', 'App or router not available for back-to-main-profile-bottom-btn');
        }
      });
    }
    ...
    if (backToMainSettingsBtn) {
      logger.info('app-event-manager', 'Adding event listener for back-to-main-settings-btn');
      backToMainSettingsBtn.addEventListener('click', (e) => {
        ...
        if (app?.router) {
          ...
          logger.warn('app-event-manager', 'App or router not available for back-to-main-settings-btn');
        }
      });
    }
    ...
    if (backToMainSettingsBottomBtn) {
      logger.info('app-event-manager', 'Adding event listener for back-to-main-settings-bottom-btn');
      backToMainSettingsBottomBtn.addEventListener('click', (e) => {
        ...
        if (app?.router) {
          ...
          logger.warn('app-event-manager', 'App or router not available for back-to-main-settings-bottom-btn');
        }
      });
    }
    ...
    const startGameBtn = document.getElementById('start-game-btn') as HTMLButtonElement;
    if (startGameBtn) {
      logger.info('app-event-manager', 'Adding event listener for start-game-btn');
      startGameBtn.addEventListener('click', async (e) => {
        ...
        if (app && typeof app.startGame === 'function') {
          try {
            ...
            logger.error('app-event-manager', 'Error calling app.startGame()', err);
          }
        } else if ((window as any).gameManager && typeof (window as any).gameManager.startGame === 'function') {
          try { await (window as any).gameManager.startGame(); } catch (err) { logger.error('app-event-manager', 'gameManager.startGame failed', err); }
        } else {
          logger.warn('app-event-manager', 'No app.startGame or gameManager.startGame available');
        }
      });
    }
    ...
    if (pauseGameBtn) {
      logger.info('app-event-manager', 'Adding event listener for pause-game-btn');
      pauseGameBtn.addEventListener('click', (e) => {
        ...
        if (gc && typeof gc.pauseGame === 'function') {
          ...
          logger.warn('app-event-manager', 'Game coordinator not available for pause');
        }
      });
    }
    ...
    if (stopGameBtn) {
      logger.info('app-event-manager', 'Adding event listener for stop-game-btn');
      stopGameBtn.addEventListener('click', (e) => {
        ...
        if (gc && typeof gc.stopGame === 'function') {
          ...
          logger.warn('app-event-manager', 'Game coordinator not available for stop');
        }
      });
    }
    ...
    document.addEventListener('click', (e) => {
      ...
      try {
        ...
        if (action.startsWith('navigate:')) {
          ...
          else logger.warn('app-event-manager', 'Router not available for navigation', route);
          return;
        }

        // Profile actions
        if (action === 'profile:refresh') {
          profileManager.loadProfile().catch((err: any) => logger.error('app-event-manager', 'profileManager.loadProfile failed', err));
          return;
        }
        ...
        if (action === 'tournament:reload') {
          ...
          else logger.warn('app-event-manager', 'Tournament manager not available for reload');
          return;
        }
        if (action === 'tournament:join') {
          ...
          else logger.warn('app-event-manager', `Tournament manager not available for join ${id}`);
          return;
        }
        if (action === 'tournament:view') {
          ...
          else logger.warn('app-event-manager', `Tournament manager not available for view ${id}`);
          return;
        }
        if (action === 'tournament:play') {
          ...
          else logger.warn('app-event-manager', `Tournament manager not available for play ${tid} ${mid}`);
          return;
        }
        if (action === 'tournament:record') {
          ...
          } else logger.warn('app-event-manager', `Tournament manager not available for record ${id}`);
          return;
        }
        ...
        if (action === 'game:find-match') {
          ...
          else logger.warn('app-event-manager', 'Game coordinator not available for find-match');
          return;
        }
        if (action === 'game:pause') {
          const gc = gameCoordinator || (window as any).gameManager || null;
          if (gc && typeof gc.pauseGame === 'function') gc.pauseGame();
          else logger.warn('app-event-manager', 'Game coordinator not available for pause');
          return;
        }
      } catch (err) {
        logger.error('app-event-manager', 'Error handling delegated data-action', err);
      }
    });
  }
   ...
   */
  cleanup(): void {
    logger.info('app-event-manager', '🧹 Cleaning up event listeners...');
    ...
    logger.info('app-event-manager', '✅ Event listeners cleaned up');
  }
}