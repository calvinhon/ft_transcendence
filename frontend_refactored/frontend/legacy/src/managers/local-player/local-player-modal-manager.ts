...
export class LocalPlayerModalManager {
  ...
  public hideLoginModal(): void {
    ...
    if (modal) {
      ...
      logger.error('local-player-modal-manager', 'Cannot hide login modal - element not found');
    }
  }
  ...
  public hideRegisterModal(): void {
    ...
    if (modal) {
      ...
      logger.error('local-player-modal-manager', 'Cannot hide register modal - element not found');
    }
  }
