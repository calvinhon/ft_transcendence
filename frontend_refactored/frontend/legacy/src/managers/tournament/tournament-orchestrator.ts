...
import { TournamentCreationManager } from './tournament-creation-manager';
import { TournamentListManager } from './tournament-list-manager';
import { TournamentBracketManager } from './tournament-bracket-manager';
import { TournamentMatchManager } from './tournament-match-manager';
import { TournamentUIManager } from './tournament-ui-manager';
import { TournamentBracketRenderer } from './tournament-bracket-renderer';
import { TournamentDragDropManager } from './tournament-drag-drop-manager';
import { TournamentNetworkManager } from './tournament-network-manager';
...
export class TournamentOrchestrator {
  ...
  public async viewTournament(tournamentId: number): Promise<void> {
    try {
      ...
      logger.error('tournament-orchestrator', 'View tournament error', error);
