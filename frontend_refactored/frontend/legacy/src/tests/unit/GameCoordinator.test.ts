import { GameCoordinator } from '../../managers/game/game-coordinator';
import { GameLifecycleManager } from '../../managers/game/game-lifecycle-manager';
import { GameModeManager } from '../../managers/game/game-mode-manager';

// Mock the dependencies
jest.mock('../../managers/game-renderer');
jest.mock('../../managers/game-input-handler');
jest.mock('../../managers/game-network-manager');
jest.mock('../../managers/game-ui-manager');
jest.mock('../../managers/campaign-manager');
jest.mock('../../managers/tournament-game-manager');
